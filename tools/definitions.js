...
2. No user spec → choose shape by volatility: 'bid_ask' if volatility >= 4, else 'spot'; choose bins based on volatility
...
- Strategy: volatility-driven — 'bid_ask' if volatility >= 4, else 'spot'
      ...
      parameters: {
        ...
        properties: {
          ...
          strategy: {
            type: "string",
            enum: ["bid_ask", "spot"],
            description: "DLMM strategy type. If user specifies, use exactly what they said. Otherwise volatility-driven: 'bid_ask' if volatility >= 4, else 'spot'."
          },
          bins_below: {
            type: "number",
